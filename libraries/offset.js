(function (f) { if (typeof exports === 'object' && typeof module !== 'undefined') { module.exports = f() } else if (typeof define === 'function' && define.amd) { define([], f) } else { let g; if (typeof window !== 'undefined') { g = window } else if (typeof global !== 'undefined') { g = global } else if (typeof self !== 'undefined') { g = self } else { g = this }g.Offset = f() } })(function () {
  let define, module, exports; return (function e (t, n, r) { function s (o, u) { if (!n[o]) { if (!t[o]) { const a = typeof require === 'function' && require; if (!u && a) return a(o, !0); if (i) return i(o, !0); const f = new Error("Cannot find module '" + o + "'"); throw f.code = 'MODULE_NOT_FOUND', f } const l = n[o] = { exports: {} }; t[o][0].call(l.exports, function (e) { const n = t[o][1][e]; return s(n || e) }, l, l.exports, e, t, n, r) } return n[o].exports } var i = typeof require === 'function' && require; for (let o = 0; o < r.length; o++)s(r[o]); return s })({
    ...
    4: [function (require, module, exports) {
      ...
      TreeBase.prototype.each = function (cb) {
        const it = this.iterator(); let data
    ...
    6: [function (require, module, exports) {
      const signedArea = require('./signed_area')
 ...
 */
    ...
    7: [function (require, module, exports) {
      const signedArea = require('./signed_area')
      const compareEvents = require('./compare_events')
 ...
 */
    ...
    10: [function (require, module, exports) {
      ...
      const edgeType = require('./edge_type')

      const Queue = require('tinyqueue')
      const Tree = require('bintrees').RBTree
      const SweepEvent = require('./sweep_event')

      const compareEvents = require('./compare_events')
      const compareSegments = require('./compare_segments')
      const intersection = require('./segment_intersection')
      const equals = require('./equals')
 ...
 */
      ...
      function _renderSweepLine (sweepLine, pos, event) {
        ...
        sweepLine.each(function (e) {
          const poly = L.polyline([e.point.slice().reverse(), e.otherEvent.point.slice().reverse()], { color: 'green' }).addTo(map)
      ...
      function subdivideSegments (eventQueue, subject, clipping, sbbox, cbbox, operation) {
        ...
        const rightbound = min(sbbox[2], cbbox[2])
        ...
        (operation === DIFFERENCE && event.point[0] > sbbox[2])) {
          ...
          if (event.left) {
            ...
            if (!prev || !next) {
            // console.log('brute');
              const iterators = findIterBrute(sweepLine)
              prev = iterators[0]
              next = iterators[1]
            }
            ...
            if (prev.data()) {
              if (possibleIntersection(prev.data(), event, eventQueue) === 2) {
                let prevprev = sweepLine.findIter(prev.data())
      ...
      function findIterBrute (sweepLine, q) {
        const prev = sweepLine.iterator()
        const next = sweepLine.iterator()
        const it = sweepLine.iterator(); let data
        while ((data = it.next()) !== null) {
          prev.next()
          next.next()
          if (data === event) {
 ...
 */
      function connectEdges (sortedEvents) {
        ...
        // "false"-filled array
        const processed = Array(resultEvents.length)
        const result = []
 ...
 */
      ...
      function boolean (subject, clipping, operation) {
        ...
        const eventQueue = fillQueue(subject, clipping, sbbox, cbbox)
 ...
 */
    ...
    }, { './compare_events': 6, './compare_segments': 7, './edge_type': 8, './equals': 9, './segment_intersection': 11, './sweep_event': 13, bintrees: 1, tinyqueue: 14 }],
 ...
 */
    ...
    16: [function (require, module, exports) {
      ...
      const orientRings = utils.orientRings
      ...
      Offset.prototype.offsetContour = function (curve, edges) {
        ...
        // we have 1 less edge than vertices
          for (i = 0, len = curve.length - 1; i < len; i++) {
            const segment = this.ensureLastPoint(
 ...
 * @return {Boolean}
 */
      const isArray = module.exports.isArray = Array.isArray || function (arr) {
        return Object.prototype.toString.call(arr) === '[object Array]'
      }
